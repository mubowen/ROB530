...
noisymotion(1)=sample(motion(1),alphas(1)*drot1^2+alphas(2)*dtran^2);
noisymotion(2)=sample(motion(2),alphas(3)*dtran^2+alphas(4)*(drot1^2+drot2^2));
noisymotion(3)=sample(motion(3),alphas(1)*drot2^2+alphas(2)*dtran^2);
